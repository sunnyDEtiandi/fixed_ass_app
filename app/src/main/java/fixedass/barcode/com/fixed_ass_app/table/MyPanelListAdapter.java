...
public class MyPanelListAdapter extends AbstractPanelListAdapter {
    ...
    private class ContentAdapter extends ArrayAdapter {
        ...
        public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            ...
            viewHolder.tv_01.setText(data.get("countBillCode"));
            viewHolder.tv_02.setText(data.get("createPeople"));
            viewHolder.tv_03.setText(data.get("createDate"));
            viewHolder.tv_04.setText(data.get("countNote"));
